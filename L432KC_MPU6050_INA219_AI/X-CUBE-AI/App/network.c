...
#define AI_NETWORK_MODEL_SIGNATURE     "0xee5bc0fd2c77bb22f19c7ee98367c67a"
...
#define AI_TOOLS_DATE_TIME   "2026-02-17T19:11:12+0900"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 21, 64, 1, 1), AI_STRIDE_INIT(4, 4, 84, 5376, 5376),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 16132, 1, 1),
    16132, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 44);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 44);
    ...
    nl_2_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 64);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 64);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 5376);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5376);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 5632);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 5632);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 13824);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 13824);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 13952);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 13952);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 16000);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 16000);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 16064);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 16064);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 16128);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 16128);
    return true;
  }
