...
#define AI_NETWORK_MODEL_SIGNATURE     "0xbc0df1e36027be3fd57eca2a676bc766"
...
#define AI_TOOLS_DATE_TIME   "2026-02-23T23:08:10+0900"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 3844, 1, 1),
    3844, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_input_layer0_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    serving_default_input_layer0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    ...
    nl_2_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 1024);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1024);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 1152);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1152);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 3200);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 3200);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 3264);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 3264);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 3776);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 3776);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 3808);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 3808);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 3840);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 3840);
    return true;
  }
